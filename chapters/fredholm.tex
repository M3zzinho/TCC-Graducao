...
\subsection{Regular Fredholm operators}
...
\begin{equation*}
    (\sub \Id E - S'T)(\sub \Id E - ST) =  (\sub\Id E - S'T) - (\sub \Id E - S'T)ST = \sub \Id E - S'T- ST + \underbrace{S'TST}_{S'T}  = \sub \Id E - ST
\end{equation*}
...
\subsection{Regularization of Fredholm operators}
...
\subsection{``Fredholm Picture of \texorpdfstring{$K_0(A)$}{K0(A)}''}
...
\end{equation*}
\textcolor{red}{Porque isso daqui é inversível?}
\end{itroman}
\end{proof}
\end{proposicao}
