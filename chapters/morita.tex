\chapter{A Fredholm operator approach to Morita-Rieffel Equivalence}
...
\begin{teorema}
	If $A$ and $B$ are Morita-Rieffel equivalent, and $X$ is the $(A,B)$-imprimitivity bimodule, then $X_* : K_0(A) \longto K_0(B)$ is an isomorphism.
\end{teorema}

Suppose that $A$ and $B$ are Morita-Rieffel equivalent, and $X$ is the certifying $(A,B)$-imprimitive bimodule. If $SA \coloneqq C_0(\R) \otimes A$ denotes the suspension $C^*$-algebra of $A$, one can induce a suspension of $X$, given by $SX \coloneqq C_0(\R)\otimes X$. Since $K_1(A) \simeq K_0(SA)$ and $SA$ and $SB$ are Morita-Rieffel equivalent, one can induce an isomorphism $(SX)_* : K_1(A) \longto K_1(B)$.